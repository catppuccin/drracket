...
;; Catppuccin goes Purrr!
  ...
  (define frappe-text)    #(198 208 245)
  (define frappe-subtext1)    #(181 191 226)
  (define frappe-subtext0)    #(165 173 206)
  (define frappe-overlay2)    #(148 156 187)
  (define frappe-overlay1)    #(131 139 167)
  (define frappe-overlay0)    #(115 121 148)
  (define frappe-surface2)    #(98 104 128)
  (define frappe-surface1)    #(81 87 109)
  ...
  (define macchiato-text)    #(202 211 245)
  (define macchiato-subtext1)    #(184 192 224)
  (define macchiato-subtext0)    #(165 173 203)
  (define macchiato-overlay2)    #(147 154 183)
  (define macchiato-overlay1)    #(128 135 162)
  (define macchiato-overlay0)    #(110 115 141)
  (define macchiato-surface2)    #(91 96 120)
  (define macchiato-surface1)    #(73 77 100)
  ...
  (define mocha-blue)    #(137 180 250)
  (define mocha-lavender)    #(180 190 254)
  (define mocha-text)    #(205 214 244)
  (define mocha-subtext1)    #(186 194 222)
  (define mocha-subtext0)    #(166 173 200)
  (define mocha-overlay2)    #(147 153 178)
  (define mocha-overlay1)    #(127 132 156)
  (define mocha-overlay0)    #(108 112 134)
  (define mocha-surface2)    #(88 91 112)
  (define mocha-surface1)    #(69 71 90)
